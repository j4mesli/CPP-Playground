...
class Dog: public Animal {
    ...
    public:
        ...
        // Constructor
        Dog(string name, double height, double weight, string sound) : Animal(name, height, weight) {
            this->sound = sound;
        }
        Dog() : Animal() {};
        ...
        // Overwrite toString
        void toString() {
            cout << "Dog " << this->getName() << " is " << this->getHeight() << " cm tall and " << this->getWeight() << " kg in weight and says " << this->sound << endl;
        }

        // Destructor (Remove from Mmory)
        ~Dog() {
            cout << "Dog " << this->getName() << " destroyed" << endl;
        };
};
